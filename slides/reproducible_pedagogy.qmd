...
# Why reproducible?![](images/researchers2.png){width="500"}

::: notes
-   we all know the importance in research
-   why bother in teaching? Two audiences: other students, instructors
-   role model effect
...
:::: {.column width="50%"}
::: columns
-   <https://duke.is/fisher-user>
:::
::::

::: {.column width="50%"}
![](images/user_link.png){width="250"}
:::
::::::
...
::::: columns
::: {.column width="50%"}
-   <https://sta360-sp25.github.io/data>
...
::: {.column width="50%"}
In a blank quarto file within the project directory, add the following YAML:
...
[Automatic schedule maker](https://athos00.github.io/scripts/auto_schedule.R)

Example schedule [here](https://sta360-sp25.github.io/)

## pandoc

Website syllabus has downloadable pdf: <https://sta360-sp25.github.io/syllabus.html>
...
$\int p(\tilde{y}|\theta) p(\theta | y_1,\ldots y_n)d\theta$ is a \_\_\_ predictive distribution.
...
The vertical line on the following plot is best described as the posterior \_\_\_\_.
...
![Sampling from the posterior in Bayesian regression](https://sta360-sp25.github.io/notes/imgs/hyperplane-search.gif){width="600"}

## Example lesson

-   <https://sta360-sp25.github.io/>

. . .

-   Source code for course website: <https://github.com/sta360-sp25/sta360-sp25.github.io>
...
-   Further reading: <https://quarto.org/docs/output-formats/html-code.html>
...
-   Further reading: <https://quarto.org/docs/interactive/layout.html>
...
-   Further reading: <https://quarto.org/docs/authoring/callouts.html>
...
-   Further reading: <https://pkg.garrickadenbuie.com/countdown/#1>
